...
const __pageData = JSON.parse('{"title":"热菜","description":"","frontmatter":{},"headers":[],"relativePath":"hot-dishes/index.md","filePath":"hot-dishes/index.md"}');
const _sfc_main = { name: "hot-dishes/index.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("hot-dishes/index.md");
