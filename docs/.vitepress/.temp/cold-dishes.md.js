...
const __pageData = JSON.parse('{"title":"冷菜","description":"","frontmatter":{},"headers":[],"relativePath":"cold-dishes.md","filePath":"cold-dishes.md"}');
const _sfc_main = { name: "cold-dishes.md" };
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("cold-dishes.md");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const coldDishes = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);
export {
  __pageData,
  coldDishes as default
};
